...
public class AvatarHMDSyncAction : PreRenderAction {
    ...
    protected override void Action() {
        ...
        // The avatar follows the position of the HMD but not its rotation (the play area is used instead)
        // This is useful for putting labels/icons that need to be floating above an avatar's head
        FollowTransform(AvatarTop, headsetTransform, headsetTransform, playAreaTransform);
    }

    protected override void OnCamPreRender(Camera cam) {
